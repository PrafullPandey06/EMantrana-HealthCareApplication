...
public class DoctorService {
    ...
    public DoctorService(DoctorRepo doctorRepository,PatientPrescriptionRepo patientPrescriptionRepo,
                         PatientRepo patientRepo,Patient_DoctorPatientRepo patient_doctorPatientRepo,
                         JwtService jwtService, JavaMailSender mailSender, PasswordEncoder passwordEncoder) {
    ...
    public String resetPassword(ForgetPasswordRequestDTO request) {
        ...
        System.out.println(doctr);
        if(doctr == null) {
            throw new RuntimeException("Doctor not found");
        }
        //doctr.setPassword(request.getPassword());
        doctr.setPassword(passwordEncoder.encode(request.getPassword()));
       doctr.setResetToken(null);
