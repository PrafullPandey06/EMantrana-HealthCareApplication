      ...
      <Box
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '10%' }} >
            ...
            <Button onClick={() => { navigate("/VerifyOTP") }}
              style={{
                width: 400,
                margin: 50,
                height: 50,
            ...
            {/* <Button onClick={() => { navigate("/PatientLogin") }}
              style={{
                width: 400,
                margin: 50,
                height: 50,
            ...
            <Button 
              ...
              onMouseEnter={(e) => e.target.style.transform = 'scale(1.2)'}
              onMouseLeave={(e) => e.target.style.transform = 'scale(1)'}
              onMouseOver={(e) => e.target.style.background = '#FEDCCB'}
              onMouseOut={(e) => e.target.style.background = '#CCF7FE'}
            >
              <h2>Patient login</h2>
            </Button>
            
            <Button onClick={() => { navigate("/DoctorLogin") }}
              style={{
                width: 400,
                margin: 50,
                height: 50,
