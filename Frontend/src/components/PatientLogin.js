...
import { setPatientId, setpatientLogin, setPatientFname,setPatientLname,setPatientDOB } from './Redux/PatientSlice';
...
function PatientLogin() {
  ...
  //     const myfunction = async () => { await delay(9000); };
        setTimeout((() => {
  ...
  return (
    <div>
      {/* <Toaster style={{margin:'50%'}} toastOptions={{duration: 4000}} /> */}
