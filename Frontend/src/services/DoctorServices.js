...
class DoctorService {
   ...
   addToQueue(data, config){
        return axios.post("http://13.51.44.140:8000/doctor/add_to_queue", data, config);
   }
   getQueue(id, config){
        return axios.get(`http://13.51.44.140:8000/doctor/get_queue/${id}`, config);
   }

   deleteQueue(id, config){
        return axios.delete(`http://13.51.44.140:8000/doctor/delete_doctor/${id}`, config);
   }

   addPrescription(data, config){
        return axios.post("http://13.51.44.140:8000/doctor/uploadprescription", data, config);
   }
